...
const ApplePaySvg = () => (
  <svg viewBox="0 0 512 210.2" height="33px" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
...
const GooglePaySvg = () => (
  <svg fill="none" viewBox="0 0 80 39" height="22px" width="80" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <clipPath id="gp-clip"><rect fill="white" height="38.1" width="80" /></clipPath>
    </defs>
  </svg>
);
    ...
    <div className="co-page">
      ...
      <form className="co-grid" onSubmit={handleSubmit} noValidate>
        ...
        <div className="co-left">
          ...
          {/* Payment — UIverse component */}
          <section className="co-section">
            <h2 className="co-section-title">Método de pago</h2>
            <div className="modal">
              <div className="uiv-form">
                <div className="payment--options">
                  <button name="paypal" type="button" aria-label="PayPal">
                    <PaypalSvg />
                  </button>
                  <button name="apple-pay" type="button" aria-label="Apple Pay">
                    <ApplePaySvg />
                  </button>
                  <button name="google-pay" type="button" aria-label="Google Pay">
                    <GooglePaySvg />
                  </button>
                </div>
                ...
                <div className="credit-card-info--form">
                  <div className="input_container">
                    <label htmlFor="card-holder" className="input_label">Titular de la tarjeta</label>
                    <input
                      id="card-holder"
                      name="holder"
                  ...
                  <div className="input_container">
                    <label htmlFor="card-number" className="input_label">Número de tarjeta</label>
                    <input
                      id="card-number"
                      name="number"
                      className="input_field"
                  ...
                  <div className="input_container">
                    <label className="input_label">Fecha de caducidad / CVV</label>
                    <div className="split">
                      <input
                        id="card-expiry"
                        name="expiry"
        ...
        <aside className="co-right">
          <div className="co-summary">
            ...
            <div className="co-summary-row">
              <span>Envío</span>
              <span className="co-free">{shipping_cost === 0 ? 'Gratis' : `${shipping_cost.toFixed(2)} €`}</span>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
            >
              {isLoading ? 'Procesando...' : `Pagar ${(total + shipping_cost).toFixed(2)} €`}
            </button>
